...
import DamageModel from '../../components/DamageModel';
          ...
          <section className='w-full min-h-[65%] h-full bg-gray-800 z-10 pt-14 flex flex-col items-center gap-3 px-5 pb-4'>
            ...
            <div className='flex w-full items-center justify-between max-w-[400px] text-center'>
              ...
              <div className='w-full'>
                <h4 className='text-[0.5rem] text-zinc-100 capitalize'>weight</h4>
              ...
              <div className='w-full'>
                <h4 className='text-[0.5rem] text-zinc-100 capitalize'>height</h4>
                <div className='text-sm flex mt-1 gap-2 justify-center text-zinc-200'>
                  <Vector />
                  {pokemon.height}cm
                </div>
              ...
              <div className='w-full'>
                <h4 className='text-[0.5rem] text-zinc-100 capitalize'>moves</h4>
